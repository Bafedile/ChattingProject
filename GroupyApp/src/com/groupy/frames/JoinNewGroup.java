...
public class JoinNewGroup extends javax.swing.JFrame {
    ...
    public JoinNewGroup(Client client) {
        this.client = client;
    ...
    private void joinButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_joinButtonActionPerformed
        ...
        if(!uniqueIdTextField.getText().isEmpty() && !grpNameTextField.getText().isEmpty()){
            try {
                String request = "joinNewGroup"+"#"+uniqueIdTextField.getText()+"::"+grpNameTextField.getText()+"::"+client.getUsername();
                boolean results = client.createGroup(request);
                System.out.println(results);
               if(results){
                   JOptionPane.showMessageDialog(null,"Joined Successfully. You are now Participant to Group: "+grpNameTextField.getText());
               }else{
                   JOptionPane.showMessageDialog(null,"Information might not be Valid, OR you are already participant to the group!!!!");
               }
               
                setVisible(false);
                new Chat1(client).setVisible(true);
            } catch (IOException ex) {
                Logger.getLogger(JoinNewGroup.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
